...
// DOM elements
const productDetailContainer = document.getElementById('productDetailContainer') as HTMLDivElement;
...
function addToCart(productId: string): void {
    const currentUser = (window as any).AuthManager?.getCurrentUser();
