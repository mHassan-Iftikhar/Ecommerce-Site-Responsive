import { addToCart as utilsAddToCart, addToWishlist as utilsAddToWishlist } from "../utils/utils";
...
(window as any).navigateToProduct = navigateToProduct; // Make navigateToProduct available globally
